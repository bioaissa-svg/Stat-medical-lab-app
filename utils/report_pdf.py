...
def build_report(
    ...
    for var, res in results.items():
        ...
        try:
            ...
            print(f"[report_pdf] Échec génération graphique pour '{var}': {err_detail}")
            story.append(Paragraph(
                f"⚠ Graphique indisponible pour {var} ({type(e).__name__}: {e})",
                ParagraphStyle("chart_err", fontName=font, fontSize=8.5,
                               textColor=colors.HexColor("#C00000"), alignment=align),
            ))
